...
tile1 = col1.container(height=190, border=False)
tile2 = col2.container(height=190, border=False)
...
tile1 = col3.container(height=190, border=False)
tile2 = col4.container(height=190, border=False)
...
tile1 = col5.container(height=190, border=False)
tile2 = col6.container(height=190, border=False)
...
tile1 = col7.container(height=190, border=False)
tile2 = col8.container(height=190, border=False)
...
tile1 = col9.container(height=190, border=False)
tile2 = col10.container(height=190, border=False)
